...
static bt_status_t _bt_app_event_callback(bt_msg_type_t msg, bt_status_t status, void *buff)
{
 ...
 */
static bt_gap_le_local_config_req_ind_t *_bt_gap_le_get_local_config(void)
{
 ...
 */
static bt_gap_le_bonding_info_t *_bt_gap_le_get_bonding_info(const bt_addr_t remote_addr)
{
    return &bonding_info;
}
 ...
 */
static bt_status_t _bt_gap_le_get_pairing_config(bt_gap_le_bonding_start_ind_t *ind)
{
...
{
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_local_cofig, 0, (void *)_bt_gap_le_get_local_config);
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_pairing_config, 0, (void *)_bt_gap_le_get_pairing_config);
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_bonding_info, 0, (void *)_bt_gap_le_get_bonding_info);
    bt_callback_manager_register_callback(bt_callback_type_app_event, MODULE_MASK_GAP | MODULE_MASK_SYSTEM, (void*)_bt_app_event_callback);
}